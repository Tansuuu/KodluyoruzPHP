        ...
        <div class="card <?php echo cookie('color') ?? 'bg-dark' ?>" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <form action="islem.php?islem=hakkimda" method="post">
                    <textarea class=" form-control <?php echo cookie('color') ?? 'bg-dark' ?> text-primary" name="hakkimda" id="hakkimda" cols="30" rows="10"><?php echo htmlspecialchars_decode($hakkimda) ?></textarea>
